	...
	<div id="tool_customization">
		...
		<div id="font-box">
			...
			<select name="font" id="font" class="font-list">
				<option value="" selected="selected">Select ambiant</option>
								<option value="font1">grass1 (default)</option>
								<option value="font2" >grass2</option>
								<option value="font3">grass3</option>
								<option value="font4">sky1</option>
								<option value="font5">sky2</option>
								<option value="font6">sky3</option>
								<option value="font7">white</option>
								<option value="font8">motif1</option>
								<option value="font9">motif2</option>
								<option value="font10">motif3</option>
				</select>
			<!--<select name="font" id="font" class="font-list">
